...
const products = [
    {
      image: 'https://emedigital.co.uk/wp-content/uploads/2022/06/ortery-360-background-removal-natural-shadow-300x300-1.jpeg',
      name: 'Shoes',
      description: 'fusion of style and comfort',
      price: 10,
      rating: 4.5,
    },
    {
    ...
    },
    {
      ...
      name: 'Leather watch',
      description: 'Withstand the rigors of everyday wear',
      price: 15,
      rating: 3.5,
    },
    {
...
const MainComponent = ({ products }) => {
  ...
  const Main = () => {
    return <MainComponent products={products} />;
  };
